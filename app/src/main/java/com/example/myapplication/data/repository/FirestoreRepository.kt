...
class FirestoreRepository @Inject constructor() {
    ...
    private suspend fun createGroup(groupData: Group): DataRequestWrapper<Unit, String, Exception> {
        return try {
    ...
    private suspend fun createTransactionForGroup(groupId: String, transactionData: Transaction): DataRequestWrapper<Unit, String, Exception> {
        return try {
            //val auth = FirebaseAuth.getInstance()
            //val currentUser = auth.currentUser
